==============================
Purchase Order for Weighbridge
==============================
...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:093eefde062bbb136069e12c5548ad039b4eb1fa1e099a220ddaf97ec905c902
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-witech--io%2Fbase_addons-lightgray.png?logo=github
    :target: https://github.com/witech-io/base_addons/tree/17.0/wi_base_weighbridge_purchase
    :alt: witech-io/base_addons

|badge1| |badge2| |badge3|

The module is used to integrate the purchase process with a weighbridge
scale, automating the creation of purchase orders when the weighbridge
scale is posted.
...
`feedback <https://github.com/witech-io/base_addons/issues/new?body=module:%20wi_base_weighbridge_purchase%0Aversion:%2017.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `witech-io/base_addons <https://github.com/witech-io/base_addons/tree/17.0/wi_base_weighbridge_purchase>`_ project on GitHub.